...
- **Activity**: RESTRICT (Impossible de supprimer si participations existent).

### Notes CRUD (interface)
- Chaque module principal expose des actions **Ajouter / Modifier / Supprimer** dans l’interface.
- Après ajout/modification/suppression, la liste (DataGridView) est rechargée.
